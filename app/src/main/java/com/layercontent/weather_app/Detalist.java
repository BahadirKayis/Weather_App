        ...
        call.enqueue(new Callback<Wee>() {
            ...
            public void onResponse(retrofit2.Call<Wee> call, Response<Wee> response) {
                if (response.isSuccessful()) {
                   ...
                   textgünsaat.setText("\n"+response.body().getLocation().getLocaltime().substring(10,16));
                  ...
                  Adapterhavadurumu adapterhavadurumu=new Adapterhavadurumu(Detalist.this,conditionList2,resimidlist,tarihlist);
